...
export function InteractiveMapbox({ onProjectClick }: InteractiveMapboxProps) {
  const mapContainer = useRef<HTMLDivElement>(null);
  const map = useRef<mapboxgl.Map | null>(null);
  const [mapLoaded, setMapLoaded] = useState(false);
  const [hoveredProject, setHoveredProject] = useState<string | null>(null);

  // Project data with real coordinates for the three specified locations
  const projects: Project[] = [
    {
      ...
      coordinates: [
        ...
        [88.5413, 22.2536],
        [89.1769, 22.1283],
        [89.0207, 21.9497] // Close the polygon
      ],
      creditsIssued: 12500,
      creditsRetired: 8300,
      areaCovered: 2800,
    ...
    },
    {
      ...
      coordinates: [
        ...
        [86.9749, 20.5898],
        [87.0583, 20.7222],
        [86.9150, 20.7681] // Close the polygon
      ],
      creditsIssued: 8900,
      creditsRetired: 5600,
      areaCovered: 1950,
    ...
    },
    {
      ...
      coordinates: [
        ...
        [79.8093, 11.4332],
        [79.7995, 11.4912],
        [79.7758, 11.4939] // Close the polygon
      ],
      creditsIssued: 15200,
  ...
  useEffect(() => {
    ...
    if (!map.current && mapContainer.current) {
      map.current = new mapboxgl.Map({
        ...
        style: 'mapbox://styles/mapbox/streets-v12', // Streets style for better visibility
  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      ...
      <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm rounded-lg p-3 shadow-lg z-10">
        <h4 className="font-semibold text-sm mb-2 text-gray-900">Blue Carbon Projects</h4>
        <div className="space-y-2 text-xs">
          <div className="flex items-center space-x-2">
            <div className="w-4 h-3 bg-blue-500 opacity-40 rounded border border-blue-600"></div>
            <span>Active Project Areas</span>
          </div>
          <div className="flex items-center space-x-2">
        ...
        <div className="text-xs text-gray-600">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <span className="ml-1">hectares</span>
            </div>
          </div>
        </div>
      </div>
