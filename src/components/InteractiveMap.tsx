...
export function InteractiveMap({ onProjectClick }: InteractiveMapProps) {
  const mapContainer = useRef<HTMLDivElement>(null);
  const map = useRef<mapboxgl.Map | null>(null);
  const [mapLoaded, setMapLoaded] = useState(false);
  const [hoveredProject, setHoveredProject] = useState<string | null>(null);

  // Mock project data for India with geographically accurate coordinates
  const projects: Project[] = [
    {
      ...
      images: [
        ...
        "https://images.unsplash.com/photo-1629215833375-edd0fb49a690?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzZWFncmFzcyUyMG1lYWRvd3MlMjB1bmRlcndhdGVyfGVufDF8fHx8MTc1OTA1NjkzMXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
      ],
      recentActivity: [
    ...
    {
      id: "BC-2024-0092",
      name: "Vembanad Lake Restoration",
      status: "Active",
      coordinates: [
        [76.5, 9.8],
        [76.3, 9.6],
      ...
      description: "Coastal backwater restoration project in Kerala focusing on seagrass meadows and local community engagement.",
      images: [
        "https://images.unsplash.com/photo-1629215833375-edd0fb49a690?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzZWFncmFzcyUyMG1lYWRvd3MlMjB1bmRlcndhdGVyfGVufDF8fHx8MTc1OTA1NjkzMXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
        "https://images.unsplash.com/photo-1753874150294-11c4a91349b3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2FzdGFsJTIwcmVzdG9yYXRpb24lMjBwcm9qZWN0fGVufDF8fHx8MTc1OTA1NjkyOHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
      ],
    ...
    {
      id: "BC-2024-0065",
      name: "Gulf of Kutch Conservation",
      status: "Active",
      coordinates: [
        [70.2, 22.5],
        [70.0, 22.3],
      ...
      areaCovered: 3400,
      verificationStatus: "Verified",
      description: "Comprehensive coastal conservation project in Gujarat including coral reef restoration and mangrove plantation.",
      images: [
        "https://images.unsplash.com/photo-1753874150294-11c4a91349b3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2FzdGFsJTIwcmVzdG9yYXRpb24lMjBwcm9qZWN0fGVufDF8fHx8MTc1OTA1NjkyOHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
        "https://images.unsplash.com/photo-1643276714790-9e30f89a5a9f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYW5ncm92ZSUyMGZvcmVzdCUyMHJlc3RvcmF0aW9ufGVufDF8fHx8MTc1OTA1NjkyNHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  useEffect(() => {
    ...
    if (!map.current && mapContainer.current) {
      map.current = new mapboxgl.Map({
        ...
        style: 'mapbox://styles/mapbox/outdoors-v12', // Outdoors style for natural features
    ...
    <div className="relative w-full h-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-gray-100 rounded-lg">
          <Card className="p-6 max-w-md mx-auto text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              To display the world map, add your Mapbox access token to the component.
            </p>
      ...
      <div className="absolute bottom-4 right-4 flex flex-col space-y-2">
        <Button
          variant="outline"
          size="icon"
          className="h-8 w-8 bg-white/90 backdrop-blur-sm hover:bg-white/95"
      ...
      <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg p-3 shadow-lg">
        <h4 className="font-semibold text-sm mb-2 text-gray-900">Map Legend</h4>
        <div className="space-y-2 text-xs">
          <div className="flex items-center space-x-2">
            <div className="w-4 h-3 bg-blue-500 opacity-40 rounded"></div>
            <span>Blue Carbon Projects</span>
          </div>
          <div className="flex items-center space-x-2">
